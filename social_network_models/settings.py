"""
Django settings for social_network_models project.
...
SECRET_KEY = 'django-insecure-2ux6utq6*1*k#$y7shn33g3od+l-=*@o13*(!p6!(v_04k0spx'
...
ROOT_URLCONF = 'social_network_models.urls'
...
WSGI_APPLICATION = 'social_network_models.wsgi.application'
